...
TOKENS_FILE = '/tmp/tokens.json'  # NEW: Persist tokens to disk
...
def save_tokens():
    """NEW: Persist active tokens to disk"""
...
def login():
    ...
    if username == ADMIN_USERNAME and password == ADMIN_PASSWORD:
        ...
        save_tokens()  # NEW: Persist token immediately
...
def logout():
    ...
    if token and token.startswith('Bearer '):
        ...
        save_tokens()  # NEW: Persist token removal
